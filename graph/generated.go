...
func (ec *executionContext) field_Mutation_createProduct_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewProduct2eᚑcommerceᚋgraphᚋmodelsᚐNewProduct(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNproduct2ᚖeᚑcommerceᚋgraphᚋmodelsᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_products(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*models.Product)
	fc.Result = res
	return ec.marshalNproduct2ᚕᚖeᚑcommerceᚋgraphᚋmodelsᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewProduct2eᚑcommerceᚋgraphᚋmodelsᚐNewProduct(ctx context.Context, v any) (models.NewProduct, error) {
...
func (ec *executionContext) marshalNproduct2eᚑcommerceᚋgraphᚋmodelsᚐProduct(ctx context.Context, sel ast.SelectionSet, v models.Product) graphql.Marshaler {
	return ec._product(ctx, sel, &v)
}

func (ec *executionContext) marshalNproduct2ᚕᚖeᚑcommerceᚋgraphᚋmodelsᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Product) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNproduct2ᚖeᚑcommerceᚋgraphᚋmodelsᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNproduct2ᚖeᚑcommerceᚋgraphᚋmodelsᚐProduct(ctx context.Context, sel ast.SelectionSet, v *models.Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
